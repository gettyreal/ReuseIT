...
- [x] **AUTH-01**: User can register with email, password, and location (address or coordinates)
- [x] **AUTH-02**: User can log in with email and password
- [x] **AUTH-03**: User session persists across browser refresh
- [x] **AUTH-04**: User can log out from any page
- [x] **USER-01**: User can view their profile (name, avatar, bio, statistics)
- [x] **USER-02**: User can edit their profile (name, bio, location)
- [x] **USER-03**: User can upload and change their avatar image
- [x] **USER-04**: User can view statistics (active listings count, completed sales, average rating)

### Listings & Discovery

- [x] **LIST-01**: User can create a listing with category, title, description, price, condition
- [x] **LIST-02**: User can upload multiple photos for a listing
- [x] **LIST-03**: User can edit their own listings
- [x] **LIST-04**: User can delete/cancel their own listings
- [x] **LIST-05**: User can view all active listings in a sortable/filterable list
- [x] **LIST-06**: User can view listing details including photos, seller info, price, condition
- [x] **LIST-07**: User can filter listings by category, price range, condition
- [x] **LIST-08**: User can search listings by keyword (title, description)

### Geolocation & Map

- [x] **GEO-01**: Listing address is converted to latitude/longitude coordinates
...
- [x] **CHAT-01**: User can view all their conversations
- [x] **CHAT-02**: User can open a conversation and view message history
- [x] **CHAT-03**: User can send messages to negotiate pickup details
- [x] **CHAT-04**: Messages show unread count for each conversation
- [x] **CHAT-05**: User can mark messages as read
- [x] **CHAT-06**: System automatically creates conversation when booking is made

### Reviews & Reputation

- [x] **REV-01**: User can leave a review (1-5 stars + optional comment) after completed booking
- [x] **REV-02**: Review is only available after pickup marked as completed
- [x] **REV-03**: User can view their own reviews received from others
- [x] **REV-04**: System calculates and displays user's average rating
- [x] **REV-05**: User profile shows number of reviews received

### Favorites & Wishlist

- [x] **FAV-01**: User can save listings to a favorites/wishlist
- [x] **FAV-02**: User can view their saved favorites
- [x] **FAV-03**: User can remove listings from favorites

### Admin & Moderation

- [x] **ADMIN-01**: Admin user role exists with special permissions
- [x] **ADMIN-02**: User can report listings as inappropriate
- [x] **ADMIN-03**: User can report other users as suspicious
- [x] **ADMIN-04**: Admin can view reported content
- [x] **ADMIN-05**: Admin can remove/hide reported listings
- [x] **ADMIN-06**: Admin can suspend/ban problematic users
...
- [x] **API-03**: API enforces authentication for protected endpoints
